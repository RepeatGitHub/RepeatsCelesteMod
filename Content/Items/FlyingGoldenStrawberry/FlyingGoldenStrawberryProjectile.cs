...
{
	public class FlyingGoldenStrawberryProjectile : ModProjectile
	{
		public override void SetStaticDefaults() {
			...
			ProjectileID.Sets.CharacterPreviewAnimations[Projectile.type] = ProjectileID.Sets.SimpleLoop(0, 9, 5)
				.WithOffset(-29, -12f)
		...
		public override void AI() {
			...
			if (!player.dead && player.HasBuff(ModContent.BuffType<FlyingGoldenStrawberryBuff>())) {
